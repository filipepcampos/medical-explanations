...
from pytorch_grad_cam.utils.model_targets import ClassifierOutputTarget, BinaryClassifierOutputTarget, ClassifierOutputSoftmaxTarget
...
for i in range(8):
    ...
    visualization = show_cam_on_image(normalize_image(x[i].cpu()), grayscale_cam_im, use_rgb=True)
